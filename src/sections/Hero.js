...
const Hero = () => {
    return (
        <section className='bg-hero-pattern2 bg-no-repeat bg-hero2Position'>
            <div className="container flex flex-col items-center lg:flex-row">
                ...
                <div className="-z-50 flex justify-center bg-hero-pattern bg-contain bg-no-repeat bg-heroPosition lg:w-1/3 lg:self-end">
